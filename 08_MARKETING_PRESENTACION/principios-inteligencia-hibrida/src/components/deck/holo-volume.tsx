  ...
  return (
    <div className={`holo-stage relative mx-auto w-full max-w-xl ${size}`}>
      <div className="pointer-events-none absolute inset-0 z-0">
        <EmilyArc tone="volume" labeled={false} />
      </div>
      <div className="pointer-events-none absolute inset-x-[12%] bottom-[8%] z-0 h-[18%] rounded-[100%] bg-holo/10" />
      <div className="holo-3d absolute inset-0 z-10">
      ...
      <div className="holo-scan pointer-events-none absolute inset-[8%] z-0 rounded-[50%] border border-holo/20" />
    </div>
  );
}
